...
export const usePlayerStore = defineStore('player', {
    ...
    actions: {
                ...
                if (prefs && Object.keys(prefs).length > 0) {
                    ...
                    if (prefs.current_playlist_id) {
                        ...
                        if (pl) {
                            ...
                            const tracks = await radioRepository.getLocalTracks(pl.local_id);
                            this.queue = tracks;
                        }
                    }
        ...
        get_current_time() {
            if (this.player_mode === 'native' && this.native_audio_instance) return this.native_audio_instance.currentTime || 0;
    ...
    persist: {
        paths: ['current_music', 'current_playlist', 'queue', 'volume', 'is_shuffle', 'active_app'],
